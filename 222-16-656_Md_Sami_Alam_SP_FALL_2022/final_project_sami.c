...
struct Project2 expense_info;
struct Project3 feed_info; // declare variables
struct Project4 sell_info;
struct Project5 employee_info;
...
void save_expense_info()
{
    ...
    fwrite(&expense_info, sizeof(struct Project2), 1, filetooperate);
    if (fwrite != 0)
    {
        printf("\nSuccessfully Saved\n");
    }
...
int expense_PID()
{
    ...
    while (fread(&expense_info, sizeof(struct Project2), 1, filetooperate))
    {
...
void delete_expense_info()
{
    ...
    while (fread(&expense_info, sizeof(struct Project2), 1, filetooperate))
    {
        if (expense_info.project_code != p_id)
        {
            fwrite(&expense_info, sizeof(struct Project2), 1, remove_file);
        }
    }
    fclose(filetooperate);
    fclose(remove_file);
...
void save_feed_history_info()
{
    ...
    fwrite(&feed_info, sizeof(struct Project3), 1, filetooperate);
    if (fwrite != 0)
    {
        printf("\nSuccessfully Saved\n");
    }
...
int feed_PID()
{
    ...
    while (fread(&feed_info, sizeof(struct Project3), 1, filetooperate))
    {
...
void delete_feed_history_info()
{
    ...
    while (fread(&feed_info, sizeof(struct Project3), 1, filetooperate))
    {
        if (feed_info.project_code != p_id)
        {
            fwrite(&feed_info, sizeof(struct Project3), 1, remove_file);
        }
    }
    fclose(filetooperate);
    fclose(remove_file);
...
void save_selling_info()
{
    ...
    fwrite(&sell_info, sizeof(struct Project4), 1, filetooperate);
    if (fwrite != 0)
    {
        printf("\nSuccessfully Saved\n");
    }
...
int sell_PID()
{
    ...
    while (fread(&sell_info, sizeof(struct Project4), 1, filetooperate))
    {
...
void delete_selling_info()
{
    ...
    while (fread(&sell_info, sizeof(struct Project4), 1, filetooperate))
    {
        if (sell_info.project_code != p_id)
        {
            fwrite(&sell_info, sizeof(struct Project4), 1, remove_file);
        }
    }
    fclose(filetooperate);
    fclose(remove_file);
...
void save_employee_info()
{
    ...
    fwrite(&employee_info, sizeof(struct Project5), 1, filetooperate);
    if (fwrite != 0)
    {
        printf("\nSuccessfully Saved\n");
    }
...
int employee_PID()
{
    ...
    while (fread(&employee_info, sizeof(struct Project5), 1, filetooperate))
    {
...
void delete_employee_salary_info()
{
    ...
    while (fread(&employee_info, sizeof(struct Project5), 1, filetooperate))
    {
        if (employee_info.project_code != p_id)
        {
            fwrite(&employee_info, sizeof(struct Project5), 1, remove_file);
        }
    }
    fclose(filetooperate);
    fclose(remove_file);
